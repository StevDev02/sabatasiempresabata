import stylesButton from "././(app)/module.css/subscribe.module.css";
import Link from "next/link";

export default function Footer() {
  return (
    <>
      <footer className="w-full -translate-y-8 h-full">
        <div className="w-full flex justify-around py-8  h-[276px] border border-black">
          <div>
            <img
          ...
          <div className="grid">
            <div className="flex flex-col gap-2">
              ...
              >
                ...
                />
                <button className={`${stylesButton.fwButtonContainer}`}>
                  <div
